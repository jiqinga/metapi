...
const zhToEn: Record<string, string> = {
  ...
  'Token 消耗分布': 'Token Distribution',
  'Token 分布': 'Token Distribution',
  'Token 构成趋势': 'Token Composition Trend',
  '每日 Token 构成趋势': 'Daily Token Composition Trend',
  ...
  '所选时间范围内没有可用的使用记录': 'No usage records in the selected time range',
  '暂无站点使用数据': 'No site usage data',
  '所选时间范围内没有站点使用记录': 'No site usage records in the selected time range',
  '暂无模型使用数据': 'No model usage data',
  '所选时间范围内没有模型使用记录': 'No model usage records in the selected time range',
  '暂无 API Key 使用数据': 'No API Key usage data',
  '所选时间范围内没有下游 Key 使用记录': 'No downstream key usage records in the selected time range',
  '暂无客户端使用数据': 'No client usage data',
  '所选时间范围内没有客户端使用记录': 'No client usage records in the selected time range',
  '暂无账号使用数据': 'No account usage data',
  '所选时间范围内没有账号使用记录': 'No account usage records in the selected time range',
  '暂无 Token 构成数据': 'No token composition data',
  '所选时间范围内没有 prompt/completion token 拆分记录': 'No prompt/completion token split records in the selected time range',
