...
const GITHUB_RELEASES_URL = 'https://api.github.com/repos/jiqinga/metapi/releases';
const DOCKER_HUB_TAGS_URL = 'https://hub.docker.com/v2/repositories/jiqinga/metapi/tags?page_size=100';
