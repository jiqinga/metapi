    ...
    const summary = await executeUpdateHelperDeploy(
      {
        namespace: 'ai',
        releaseName: 'metapi',
        chartRef: 'oci://ghcr.io/jiqinga/charts/metapi',
    ...
    expect(calls).toEqual([
      ...
      },
      {
        ...
        args: [
          'upgrade',
          'metapi',
          'oci://ghcr.io/jiqinga/charts/metapi',
          '--namespace',
          'ai',
          '--reuse-values',
          '--set',
          'image.repository=jiqinga/metapi',
          '--set',
          'image.tag=1.3.0',
          '--set-string',
          'image.digest=',
                ...
                items: [
                  {
                    status: {
                      containerStatuses: [
                        {
                          imageID: 'docker-pullable://jiqinga/metapi@sha256:cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc',
                        },
                      ],
                    },
                  },
                ...
                items: [
                  {
                    status: {
                      ...
                      containerStatuses: [
                        {
                          ready: true,
                          imageID: 'docker-pullable://jiqinga/metapi@sha256:1523dfcbaca146b8a64a3a022878165027900ee4cb396a45e474aa7a969dacb1',
                        },
                      ],
                    },
                  },
